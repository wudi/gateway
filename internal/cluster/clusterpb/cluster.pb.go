...
func (x *NodeStatus) GetGatewayVersion() string {
	if x != nil {
...
const file_cluster_proto_rawDesc = "" +
	"\n" +
	"\rcluster.proto\x12\x12gateway.cluster.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\x9a\x01\n" +
	"\vNodeMessage\x12>\n" +
	"\aconnect\x18\x01 \x01(\v2\".gateway.cluster.v1.ConnectRequestH\x00R\aconnect\x12D\n" +
	"\theartbeat\x18\x02 \x01(\v2$.gateway.cluster.v1.HeartbeatRequestH\x00R\theartbeatB\x05\n" +
	"\x03msg\"\x80\x01\n" +
	...
	"\x06source\x18\x05 \x01(\tR\x06source\"\xe5\x01\n" +
	"\x10HeartbeatRequest\x12\x17\n" +
	"\anode_id\x18\x01 \x01(\tR\x06nodeId\x12%\n" +
	"\x0econfig_version\x18\x02 \x01(\x04R\rconfigVersion\x12\x1f\n" +
	"\vconfig_hash\x18\x03 \x01(\x04R\n" +
	"configHash\x126\n" +
	"\x06status\x18\x04 \x01(\v2\x1e.gateway.cluster.v1.NodeStatusR\x06status\x128\n" +
	"\ttimestamp\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp\"\xae\x02\n" +
	"\n" +
	"NodeStatus\x12\x16\n" +
	...
	"\x17last_successful_version\x18\a \x01(\x04R\x15lastSuccessfulVersion2g\n" +
	"\x0eClusterService\x12U\n" +
	"\fConfigStream\x12\x1f.gateway.cluster.v1.NodeMessage\x1a .gateway.cluster.v1.ConfigUpdate(\x010\x01B4Z2github.com/wudi/gateway/internal/cluster/clusterpbb\x06proto3"
...
var file_cluster_proto_goTypes = []any{
	(*NodeMessage)(nil),           // 0: gateway.cluster.v1.NodeMessage
	(*ConnectRequest)(nil),        // 1: gateway.cluster.v1.ConnectRequest
	(*ConfigUpdate)(nil),          // 2: gateway.cluster.v1.ConfigUpdate
	(*HeartbeatRequest)(nil),      // 3: gateway.cluster.v1.HeartbeatRequest
	(*NodeStatus)(nil),            // 4: gateway.cluster.v1.NodeStatus
	(*timestamppb.Timestamp)(nil), // 5: google.protobuf.Timestamp
}
var file_cluster_proto_depIdxs = []int32{
	1, // 0: gateway.cluster.v1.NodeMessage.connect:type_name -> gateway.cluster.v1.ConnectRequest
	3, // 1: gateway.cluster.v1.NodeMessage.heartbeat:type_name -> gateway.cluster.v1.HeartbeatRequest
	5, // 2: gateway.cluster.v1.ConfigUpdate.timestamp:type_name -> google.protobuf.Timestamp
	4, // 3: gateway.cluster.v1.HeartbeatRequest.status:type_name -> gateway.cluster.v1.NodeStatus
	5, // 4: gateway.cluster.v1.HeartbeatRequest.timestamp:type_name -> google.protobuf.Timestamp
	0, // 5: gateway.cluster.v1.ClusterService.ConfigStream:input_type -> gateway.cluster.v1.NodeMessage
	2, // 6: gateway.cluster.v1.ClusterService.ConfigStream:output_type -> gateway.cluster.v1.ConfigUpdate
