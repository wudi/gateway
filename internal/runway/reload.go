...
func (g *Runway) buildRouteHandlerForState(s *gatewayState, routeID string, cfg config.RouteConfig, route *router.Route, rp *proxy.RouteProxy) http.Handler {
	// We temporarily swap the Runway's fields to build the handler, then swap back.
