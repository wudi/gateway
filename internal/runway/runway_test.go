...
func TestRunwayNew(t *testing.T) {
...
func TestRunwayHandler(t *testing.T) {
	backend := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
...
func TestRunwayWithAuth(t *testing.T) {
	backend := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
...
func TestRunwayStats(t *testing.T) {
	backend := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.WriteHeader(http.StatusOK)
	}))
	defer backend.Close()
...
func TestRunwayTransform(t *testing.T) {
	...
	// Check added header
	if receivedHeaders.Get("X-Runway") != "test-gateway" {
		t.Error("X-Runway header should be added")
	}
...
func TestRunwayCacheHitMiss(t *testing.T) {
...
func TestRunwayCircuitBreaker(t *testing.T) {
	backend := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
...
func TestRunwayNoCacheOnNonCachedRoute(t *testing.T) {
	backend := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.WriteHeader(http.StatusOK)
		w.Write([]byte("ok"))
	}))
...
func TestRunwayUpstreamResolution(t *testing.T) {
	backend := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
...
func TestRunwayUpstreamSharedByTwoRoutes(t *testing.T) {
...
func TestRunwayUpstreamWithLBInheritance(t *testing.T) {
...
func TestRunwayGetUpstreams(t *testing.T) {
	backend := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.WriteHeader(http.StatusOK)
	}))
	defer backend.Close()
...
func TestRunwayNewFeatureGetters(t *testing.T) {
	backend := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.WriteHeader(http.StatusOK)
	}))
	defer backend.Close()
