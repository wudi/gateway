...
| `POST /cache/purge` | Purge cached entries by route, key, or all (see [Caching](../caching/caching.md#cache-invalidation-api)) |
...
See [Traffic Replay](../observability/traffic-replay.md) for full documentation.
...
See [gRPC Proxy — Reflection](../protocol/grpc-proxy.md#grpc-reflection-proxy) for configuration.
...
See [GraphQL Federation](../protocol/graphql-federation.md) for configuration.
...
See [API Deprecation Lifecycle](../traffic-routing/deprecation.md) for configuration.
...
See [SLI/SLO Enforcement](../resilience/slo.md) for configuration.
...
See [Developer Portal](../observability/developer-portal.md) for full documentation.
...
See [Caching](../caching/caching.md#cache-invalidation-api) for full documentation.
...
See [Load Shedding](../resilience/load-shedding.md) for configuration and behavior details.
...
See [Baggage Propagation](../transformations/baggage-propagation.md) for configuration and source types.
...
See [Backend Backpressure](../resilience/backpressure.md) for configuration and behavior details.
...
See [Audit Logging](../observability/audit-logging.md) for configuration, webhook payload format, and examples.
...
See [Data Manipulation](../transformations/data-manipulation.md#jmespath-query-language) for configuration.
...
See [Data Manipulation](../transformations/data-manipulation.md#field-level-content-replacer) for configuration.
...
See [Data Manipulation](../transformations/data-manipulation.md#martian-style-modifiers) for configuration.
...
See [Data Manipulation](../transformations/data-manipulation.md#error-handling-modes) for configuration.
...
See [Data Manipulation](../transformations/data-manipulation.md#lua-scripting) for configuration.
...
See [AWS Lambda Backend](../protocol/lambda.md) for configuration.
...
See [AMQP/RabbitMQ Backend](../protocol/amqp.md) for configuration.
...
See [Go CDK Pub/Sub Backend](../protocol/pubsub.md) for configuration.
...
See [WASM Plugins](../security/wasm-plugins.md) for configuration.
...
See [Schema Evolution](../resilience/schema-evolution.md) for configuration.
