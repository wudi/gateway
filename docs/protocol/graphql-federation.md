...
- [Admin API Reference](../reference/admin-api.md#graphql-federation) — Federation stats endpoint
- [Configuration Reference](../reference/configuration-reference.md) — Full config schema
- [Examples](../getting-started/examples.md#graphql-federation) — Complete working config
